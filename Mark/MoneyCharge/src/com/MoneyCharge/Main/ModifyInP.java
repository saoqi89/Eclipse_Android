...
import com.MoneyCharge.Model.TB_Pay;
...
public class ModifyInP extends Activity{
	...
	protected void onStart(){
		...
		} else if (strType.equals("btnininfo"))// 如果类型是btnininfo
		{
			...
			spType.setSelection(tb_income.getType());// 显示类别
	...
	private void gotoIncome(){
		...
		Intent intent=new Intent(ModifyInP.this,Income.class);
		intent.putExtra("cwp.id",userid);
		startActivity(intent);
	}
	private void gotoPay(){
		 
		Intent intent=new Intent(ModifyInP.this,Pay.class);
		intent.putExtra("cwp.id",userid);
		startActivity(intent);
	}
