...
public class Account  extends Activity{
	...
	public void onStart(){
		...
		adminlogin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(Account.this,"已切换为默认用户", Toast.LENGTH_LONG).show();
				startActivity(intent);
			}
		});
	...
	private void deleteDialog(){  //退出程序的方法 
		 ...
		 customBuilder.setTitle("警告")  // 创建标题
	        ...
	        .setMessage("此操作将删除当前用户及该用户所有数据，确定删除吗？")    //表示对话框的内容
	        ...
	        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
	           ...
	           public void onClick(DialogInterface dialog, int which) {
	        	   if(userid!=100000001){
		        	   ...
		        	   Intent intent = new Intent(Account.this, Index.class);
		        	   intent.putExtra("cwp.id",100000001);
					   Toast.makeText(Account.this,"删除成功，已登陆默认用户", Toast.LENGTH_LONG).show();
					   startActivity(intent);
	        	   }
	        	   else{

					   Toast.makeText(Account.this,"默认用户不允许删除！", Toast.LENGTH_LONG).show();
		           	   dialog.dismiss();
	        	   }
	            }
